...
class NatureQN(Linear):
    ...
    def initialize_models(self):
        ...
        #It is some how does not work in q6_train_ataru_nature.py , because for this file it requires 576 units in the first Linear Layer but in q6 it requires 1024
        self.q_network = nn.Sequential(nn.Conv2d(input_size, 16, kernel_size=3, stride=1),
                                       nn.ReLU(),
                                       nn.Flatten(),
        ...
        self.target_network = nn.Sequential(nn.Conv2d(input_size, 16, kernel_size=3, stride=1),
                                       nn.ReLU(),
                                       nn.Flatten(),
    ...
    def get_q_values(self, state, network):
        ...
        #SOMETHING WITH BATCH?
        for i in range(state.shape[0]):
            if network == 'q_network':
                input_tensor = state[i]
